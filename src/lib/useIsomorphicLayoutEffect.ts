 ...
 * work is genuinely layout work — measuring where a quote landed so a margin
 * note can be moved level with it, which has to happen before the browser
 * paints or the note is visibly seen jumping into place.
 *
