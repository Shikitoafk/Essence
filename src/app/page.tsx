      ...
      <section id="try" className="scroll-mt-8 mx-auto max-w-7xl px-5 py-24 sm:px-8 lg:px-10 lg:py-32">
        <Reveal>
          <div className="mb-10 max-w-2xl">
            ...
            <h2 className="mt-5 font-display text-4xl font-medium leading-[1.02] tracking-[-0.05em] text-ink sm:text-6xl">Try Essence on your own words.</h2>
            <p className="mt-5 max-w-xl leading-7 text-muted">Paste a 40–220 word excerpt and get one real Essence finding. No account and no saved draft. One free trial per day.</p>
          </div>
          <SampleReadDemo />
        </Reveal>
      </section>
